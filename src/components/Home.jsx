...
const Home = () => {
    return (
        <section className="bg-gradient-to-r flex flex-col items-center px-12 py-20 min-h-screen">
            <div className="flex flex-col md:flex-row items-center w-full max-w-screen-xl mx-auto">
                ...
                <div className="w-full md:w-1/2 mt-4 md:mt-0 flex justify-center md:justify-end relative">
                    <div
                        className="rounded-sm shadow-lg w-full sm:w-[20rem] md:w-[30rem] h-[30rem] sm:h-[28rem] md:h-[30.125rem] bg-cover bg-start"
